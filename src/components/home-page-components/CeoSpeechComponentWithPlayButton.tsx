// components/CeoSpeechComponentWithPlayButton.tsx (Alternative with play button overlay)
"use client";
...
const CeoSpeechComponentWithPlayButton = () => {
      ...
      <section className="w-full py-20 px-4 overflow-hidden">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            {/* Right Side - CEO Image with Play Button Overlay */}
                ...
                {ceoData.profileImageUrl ? (
                  ...
                  >
                    <div className="text-center">
                      <svg className="w-24 h-24 mx-auto mb-4" fill="currentColor" viewBox="0 0 24 24" style={{ color: theme.primary }}>
                ...
                {ceoData.videoUrl && videoId && (
                  <>
                    ...
                    <button
                      ...
                      className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-20 h-20 rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110 shadow-xl"
                      style={{
...
export default CeoSpeechComponentWithPlayButton;